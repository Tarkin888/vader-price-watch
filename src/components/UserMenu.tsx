      ...
      <div ref={ref} className="relative">
        ...
        {open && (
          ...
          >
            ...
            <button
              onClick={() => { setOpen(false); setBugModalOpen(true); }}
              className="w-full text-left text-[11px] tracking-wider py-2 flex items-center gap-2 transition-colors"
              style={{ color: "#e0d8c0", opacity: 0.8, minHeight: 44 }}
            >
              <Bug className="w-3.5 h-3.5" style={{ color: "#C9A84C" }} />
              Report a Bug
            </button>
            <button
