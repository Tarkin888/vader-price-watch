...
const AUCTION_SOURCES = [
  ...
  { name: "Vectis Auctions", location: "Thornaby, UK", currency: "GBP", premium: "22.5% + VAT (effective ~27% inclusive)", bestFor: "Palitoy; UK/European carded figures; large volume vintage toy sales", website: "vectis.co.uk", notes: "Leading UK vintage toy auction house" },
